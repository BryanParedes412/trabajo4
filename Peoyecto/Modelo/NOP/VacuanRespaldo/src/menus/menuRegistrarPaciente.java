 ...
 * @author USER
 */
public class menuRegistrarPaciente extends javax.swing.JFrame {

    /**
     * Creates new form menuRegsitrarPaciente
     */
    public menuRegistrarPaciente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtFechaNacimiento.setText("<Digeite su fecha de nacimiento (dd-mm-yyyy)>");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
            ...
            Date fechaNac = null;
        try {
            fechaNac = formato.parse(txtFechaNacimiento.getText());
        } catch (ParseException ex) {
            Logger.getLogger(menuRegistrarPaciente.class.getName()).log(Level.SEVERE, null, ex);
        }
                    ...
                    if (registrado == 0) {
                        try {
                            while ((linea = lector.readLine()) != null) {
                                ...
                                Date fechaRegsitrar = null;
                                try {
                                    fechaRegsitrar = formato.parse(conteo[6]);
                                } catch (ParseException ex) {
                                    Logger.getLogger(menuRegistrarPaciente.class.getName()).log(Level.SEVERE, null, ex);
                                }
                                Paciente lectorPaciente = new Paciente(conteo[0], conteo[1], conteo[2], conteo[3], conteo[4], conteo[5], fechaRegsitrar);
                                if (paciente.codDoc == null ? lectorPaciente.codDoc == null : paciente.codDoc.equals(lectorPaciente.codDoc)) {
                                    registrado++;
                                    JOptionPane.showMessageDialog(null, "Este paciente ya ha sido registrado(a)");
                                }
                    ...
                    if (registrado == 0) {
                        try {
                            ...
                            if (cont==0) {
                                ...
                                escriba.newLine();
                                escriba.write(paciente.nombre + "/" + paciente.apellido + "/" + paciente.telefono + "/" + paciente.tipoDoc+"/"+paciente.codDoc+"/"+paciente.domicilio+"/"+paciente.fechaNac);
                            } else {
                                escritor = new FileWriter(archivo, true);
                                escriba = new BufferedWriter(escritor);
                                escriba.write(paciente.nombre + "/" + paciente.apellido + "/" + paciente.telefono + "/" + paciente.tipoDoc+"/"+paciente.codDoc+"/"+paciente.domicilio+"/"+paciente.fechaNac);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuRegistrarPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new menuRegistrarPaciente().setVisible(true);
            }
        });
    }
